#ifndef AVARAGEPUTNAME_H
#define AVARAGEPUTNAME_H
...
void calculateAveragePutName(HashTable &user_name_table, const std::string &table_name) {
    ...
    for (int i = 0; i < 20; ++i) {
        ...
        stats current_stats = readCSV(user_name_table, 2);
