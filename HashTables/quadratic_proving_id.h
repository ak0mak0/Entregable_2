#ifndef QUADRATICPROBINGID_H
#define QUADRATICPROBINGID_H
...
class QuadraticProbingID : public HashTable {
private:
    struct Slot {
...
public:
    QuadraticProbingID(int capacity) : table(capacity), capacity(capacity), size(0) {}
