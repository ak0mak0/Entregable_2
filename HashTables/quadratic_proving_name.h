#ifndef QUADRATICPROBINGNAME_H
#define QUADRATICPROBINGNAME_H
...
class QuadraticProbingName : public HashTable {
private:
    struct Slot {
...
public:
    QuadraticProbingName(int capacity) : table(capacity), capacity(capacity), size(0) {}
