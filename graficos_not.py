...
carpeta_datos = '/home/ak0mak0/Escritorio/Entregable_2/experiment_not_results'
...
for archivo in archivos:
    ...
    plt.title(f'Tiempo de ejecución por búsqueda de usuario no almacenado - {archivo[:-4]}')
    plt.grid(True)
    plt.legend()
